...
(function ($) {
    ...
    var GoogleTranslator = {
        ...
        changeCurrentLanguage: function (lang) {
            ...
            GoogleTranslator.triggerEvent(
                $("#google_translate_element").find("select").get(0),
                "change"
            );
        },
        ...
        translatorDropdown: function () {
            $(document).on("click", "[data-ai-translator]", function (e) {
                ...
                $(".ai-translator-dropdown-wrap .ai-translator-dropdown")
                    .not(_this.parent().find(".ai-translator-dropdown"))
                    .removeClass("active");
                _this
                    .parent()
                    .find(".ai-translator-dropdown")
                    .toggleClass("active");
            });
            ...
            $(document).on(
                ...
                function (e) {
                    ...
                    if ($this.hasClass("change-text")) {
                        $this
                            .parents(".ai-translator-dropdown-wrap")
                            .find("[data-ai-translator]")
                            .text($this.text());
                    }
                }
            );
    ...
    $.fn.googleTranslator = function (options) {
        ...
        if (settings.button) {
            return plugin.each(function () {
                ...
                $(_this).on("click", function (e) {
                    ...
                    var lang = $(e.currentTarget).data(
                        "ai-translator-button-lang"
                    );
        ...
        if (settings.dropdown || settings.dropdownFlag) {
            return plugin.each(function () {
                ...
                var dropdownEl = $(
                    '<div class="ai-translator-dropdown" data-simplebar><ul></ul></div>'
                );

                if (
                    settings.dropdownFlag ||
                    (settings.dropdownFlag && settings.dropdown)
                ) {
                    var changeText = "";
        ...
        if (!settings.button && !settings.drowdown) {
            return plugin.each(function () {
                ...
                var selectEL = $(
                    '<select class="ai-google-translate-select-element" data-translator-select></select>'
                );
